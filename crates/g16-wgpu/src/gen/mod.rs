...
//!
//! [`gather`] is stage 0's generator and [`ntt`] is stages 1 to 3's. Later units add
//! `gen::msm` next to them. They all put a field prelude in front of their own entry
//! points: [`field::field_module`] when they need `Fq` and `Fq2`, or just `FR.ops` when,
